...
const token = '6101063787:AAHIroCT09Seg6DagDgXlCEvYhbMIf0ewyY'; 
const webAppUrl = 'https://stately-cassata-00807f.netlify.app';
...
bot.on('message', async (msg) => {
  ...
  const text = msg.text;
    ...
    if(text === '/start') {
        ...
        await bot.sendMessage(chatId, 'Заходи на наш интернет магазин', {
            reply_markup: {
                inline_keyboard: [
